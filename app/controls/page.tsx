...
import DltStorageComp from "../components/dltStorage";
    ...
    <MotionDiv className={styles.page}>
      ...
      >
        <MotionSection className={styles.controls_div} variants={itemVariants}>
          ...
          <MotionArticle className={styles.main_para} variants={itemVariants}>
        ...
        <MotionSection className={styles.controls_div} variants={itemVariants}>
          ...
          <MotionArticle className={styles.main_para} variants={itemVariants}>
            <MotionDiv className={styles.doc_para} variants={itemVariants}>
        ...
        <MotionSection className={styles.controls_div} variants={itemVariants}>
          ...
          <MotionArticle className={`${styles.main_para} ${styles.list_before_div}`} variants={itemVariants}>
            <MotionP className={styles.doc_info} variants={itemVariants}>
            ...
            <MotionP className={styles.doc_info} variants={itemVariants}>
              Adding <MotionSpan className={styles.red}>Danger Zone</MotionSpan> and Deleting All Data Button
            </MotionP>
          </MotionArticle>
        </MotionSection>
        <MotionSection className={styles.controls_div} variants={itemVariants}>
          <MotionH1 className={`${styles.controls_title} ${styles.red} ${styles.red_border}`} variants={itemVariants}>Danger Zone</MotionH1>
          <MotionArticle className={`${styles.main_para} ${styles.red_border}`} variants={itemVariants}>
            <DltStorageComp />
          </MotionArticle>
        </MotionSection>
      </MotionMain>
